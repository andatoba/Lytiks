...
// Script integrado para Fase 4
class Fase4ScriptPage extends StatefulWidget {
  final PlanSeguimientoMokoService service;
  final int focoId;
  ...
  @override
  State<Fase4ScriptPage> createState() => _Fase4ScriptPageState();
}

class _Fase4ScriptPageState extends State<Fase4ScriptPage> {
  ...
  final Map<String, List<Map<String, dynamic>>> _config = {
    'SUELOS SUPRESIVOS': [
      {
        'ciclo': 'PRIMER CICLO',
        'descripcion': 'APLICACIÓN DE CHOQUE',
        'productos': [
          {'producto': 'Golden Crop', 'dosis': '3LT'},
          {'producto': 'Saferbacter', 'dosis': '250 GR'},
        ]
      },
      {
        'ciclo': 'SEGUNDO CICLO',
      ...
      },
      {
        ...
        'productos': [
          {'producto': 'Golden Crop', 'dosis': '3LT'},
          {'producto': 'SAFERSOIL', 'dosis': '250 GR'},
        ]
      },
      {
        'ciclo': 'CUARTO CICLO',
              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (context, cicloIndex) {
                    ...
                    final descripcion = ciclo['descripcion'] ?? '';
                    final productos = ciclo['productos'] as List<Map<String, String>>;
              ...
              onPressed: _isSaving
                  ...
                  : () {
                      ...
                      for (final ciclo in ciclosData) {
                        ...
                        final descripcion = ciclo['descripcion']?.toString() ?? '';
                        final productos =
