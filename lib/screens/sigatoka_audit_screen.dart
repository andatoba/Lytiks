...
class _SigatokaAuditScreenState extends State<SigatokaAuditScreen> {
  ...
  Future<void> _initializeDatabase() async {
    try {
      ...
      debugPrint('✅ Base de datos inicializada correctamente en Sigatoka screen');
    } catch (e) {
      ...
      if (hasConnection) {
        try {
          ...
          if (result['success'] == true) {
            ...
            message = 'Auditoría Sigatoka guardada y sincronizada exitosamente.';
          } else {
            message = 'Auditoría guardada localmente. Se sincronizará cuando haya conexión estable.';
          }
        } catch (e) {
          message = 'Auditoría guardada localmente. Error en sincronización: ${e.toString()}';
        }
      } else {
        message = 'Auditoría guardada localmente. Sin conexión a internet. Se sincronizará automáticamente cuando haya conexión.';
      }
